...
## 스크리닝 특수 기능
- 언더밸류에이션 스코어: 0~100점 (PER/PBR/FCF Yield 정규화 합산)
- 오버히트 알럿: RSI 70+ & PER 업종평균 2배 초과 시 자동 플래그
- 주도 섹터 감지: ETF 자금흐름 + 어닝 리비전으로 현재 강한 섹터 분류
- 에이전트 반론 라운드: 리스크 매니저가 낙관론에 반박
- 에이전트 성적표: 과거 분석 의견 vs 실제 주가 성과 기록
...
## 현재 개발 단계
Phase 0 — 프로젝트 세팅 완료, Phase 1 시작 예정
