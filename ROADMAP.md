...
- [ ] 매도(SELL): `#ef4444` (빨강)
- [ ] 중립(HOLD): `#f59e0b` (앰버)
- [ ] 상승: `#22c55e` / 하락: `#ef4444` (주식 앱 표준)
- [ ] 경고/과열: `#f97316` (오렌지) / 위험: `#ef4444`
- [ ] 포인트 컬러: `#3b82f6` (파란색) — 버튼, 링크, 활성 탭

#### 레이아웃 구조
- [ ] 좌측 사이드바 네비게이션 (탭 전환) — 너비 220px 고정
- [ ] 우측 메인 콘텐츠 영역
- [ ] 상단 글로벌 검색바 (항상 노출)
- [ ] 반응형 없음 (데스크톱 전용, 최소 너비 1280px)

#### 공통 컴포넌트 규칙
- [ ] 카드 컴포넌트 — `border-radius: 8px`, 보더 `#30363d`
- [ ] 배지 컴포넌트 — 과열 등급 색상 표시
- [ ] 스켈레톤 로딩 — AI 분석 중 표시용
- [ ] 숫자 색상 — 양수 초록, 음수 빨강 (수익률, 등락률 등)
